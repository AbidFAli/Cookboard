...
const ServingInfoList = ({
  ...
  const handleChangeNumServed = (numServedText) => {
    ...
    if (numServedText.trim() === "") {
      ...
      dispatchErrors({
        type: "add",
        errorKey: ERROR_NUM_SERVED,
        errorMessage: ERROR_MSG_NUM_SERVED_NAN,
      });
    }
  };
  const handleChangeYield = (servingYieldText) => {
    ...
    if (servingYieldText.trim() === "") {
      ...
      dispatchErrors({
        type: "add",
        errorKey: ERROR_YIELD,
        errorMessage: ERROR_MSG_YIELD_NAN,
      });
    }
  };
      ...
      <List component="ul">
        <ListItem>
          <TextField
            ...
            defaultValue={
              servingInfo != null && servingInfo.numServed != null
                ? servingInfo.numServed
                : ""
            }
        ...
        <ListItem>
          <TextField
            ...
            defaultValue={
              servingInfo != null && servingInfo.yield != null
                ? servingInfo.yield
                : ""
            }
        ...
        <ListItem>
          <UnitedValue
            value={
              servingInfo != null && servingInfo.servingSize != null
                ? servingInfo.servingSize
                : 0
            }
            valueName="Serving Size"
            unit={
              servingInfo != null && servingInfo.unit != null
                ? servingInfo.unit
                : ""
            }
    ...
    content = (
      <List component="ul">
        {servingInfo.numServed !== undefined && (
          <ListItem>
            <ListItemText
              primary={`Serves: ${servingInfo.numServed} ${
                servingInfo.numServed === 1 ? "person" : "people"
              }`}
            />
          </ListItem>
        )}
        ...
        {servingInfo.servingSize !== undefined && (
          <ListItem>
            <ListItemText
              primary={`Serving size: ${servingInfo.servingSize} ${
                servingInfo.unit ? servingInfo.unit : ""
              }`}
            />
          </ListItem>
        )}
...
ServingInfoList.propTypes = {
  servingInfo: PropTypes.object,
  setServingInfo: PropTypes.func,
